...
import { z } from "zod";
import { ProcessSchema } from "@/utils/interfaces";
import { countCurrentMonth } from "@/utils/funtions";

interface Props {
  initialData: z.infer<typeof ProcessSchema>[];
}

const ProcessCards: React.FC<Props> = ({ initialData }) => {
