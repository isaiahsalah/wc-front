...
import { z } from "zod";
import { SectorSchema } from "@/utils/interfaces";
import { countCurrentMonth } from "@/utils/funtions";

interface Props {
  initialData: z.infer<typeof SectorSchema>[];
}

const SectorCards: React.FC<Props> = ({ initialData }) => {
