...
import { z } from "zod";
import { FormulaSchema, GeneralSchema } from "@/utils/interfaces";
import { countCurrentMonth } from "@/utils/funtions";

interface Props {
  initialData: z.infer<typeof FormulaSchema>[];
}

const FormulaCards: React.FC<Props> = ({ initialData }) => {
