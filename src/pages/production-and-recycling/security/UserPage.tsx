...
} from "@/components/dialog/production-and-recycling/security/UserDialogs";
import {getUsers} from "@/api/production-and-recycling/security/user.api";
import {EditPermissionUserDialog} from "@/components/dialog/production-and-recycling/security/PermissionDialog";
interface Props {
  degree: number;
}
