...
import { z } from "zod";
import {   MachineSchema } from "@/utils/interfaces";
import { countCurrentMonth } from "@/utils/funtions";

interface Props {
  initialData: z.infer<typeof MachineSchema>[];
}

const MachineCards: React.FC<Props> = ({ initialData }) => {
